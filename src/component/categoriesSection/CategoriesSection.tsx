      ...
      <div className="BackgroundSection relative py-24 px-10   lg:py-32 inset-y-0 w-screen xl:max-w-[1340px] 2xl:max-w-screen-2xl left-1/2 transform -translate-x-1/2 xl:rounded-[40px] z-0 bg-neutral-100/70 dark:bg-black/20">
        <div className="relative ">
          ...
          <div className="grid gap-4 md:gap-7 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
            <CategoryCard image={explore1} pattern={explore1Pattern} count={155} title={"Backpack"} />
            <CategoryCard image={explore2} pattern={explore2Pattern} count={22} title={"Shoes"} />
            <CategoryCard image={explore3} pattern={explore3Pattern} count={144} title={"Recycled Blanked"} />
            <CategoryCard image={explore4} pattern={explore4Pattern} count={343} title={"Cycling Shorts"} />
            <CategoryCard image={explore5} pattern={explore5Pattern} count={222} title={"Cycling Jersey"} />
            <CategoryCard image={explore6} pattern={explore6Pattern} count={155} title={"Car Coat"} />
