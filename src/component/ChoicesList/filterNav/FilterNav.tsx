      ...
      <nav className=" relative flex w-full overflow-x-auto text-sm md:text-base hiddenScrollbar">
        <ul className="flex  sm:space-x-2">
          <li className="relative">
            <button  className={disActiveClass} onClick={handleClick}>
              All items
            </button>
          </li>
          <li className="relative">
            <button name="women" className={disActiveClass} onClick={handleClick}>
              Women
            </button>
          </li>
          <li className="relative">
            <button name="men" className={disActiveClass} onClick={handleClick}>
              Mans
            </button>
          </li>
          <li className="relative">
            <button name="kids" className={disActiveClass} onClick={handleClick}>
              Kids
            </button>
          </li>
          <li className="relative">
            <button name="jewels" className={disActiveClass} onClick={handleClick}>
              jewels
            </button>
          </li>
        </ul>
