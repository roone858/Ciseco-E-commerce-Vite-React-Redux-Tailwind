...
// Update the import path below to the correct location of SpannerIcon, for example:
...
// If SpannerIcon is not available, you may need to create the Icons.tsx file and export SpannerIcon from it.
